...
try {
    ...
    // Calculate average score (percentage) for circular chart display
    $avgScorePercent = floatval($stats['avg_score']); // already a percentage value
...
<body>
  <div class="dashboard-container">
    ...
    <div class="main-content">
      ...
      <!-- Circular (Doughnut) Chart for Average Score -->
      <div class="chart-container">
        <h2>Average Score Overview</h2>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Average Score Doughnut Chart
      const avgScore = <?php echo $avgScorePercent; ?>;
      ...
      new Chart(ctxAvg, {
        ...
        data: {
          ...
          datasets: [{
            ...
            hoverBackgroundColor: ['#28a745', '#e0e0e0'],
            borderWidth: 1
          }]
        },
        options: {
          responsive: true,
          cutout: '70%', // creates the circular "ring" effect
          plugins: {
            tooltip: {
              callbacks: {
            ...
            // Plugin for center text (using Chart.js v3+ custom plugin)
